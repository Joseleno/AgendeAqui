...
public class AppointmentCancelledDomainEventHandlerTests
{
    ...
    public AppointmentCancelledDomainEventHandlerTests()
    {
        ...
        _handler = new AppointmentCancelledDomainEventHandler(_eventBus, _tenantProvider, _hubNotifier, logger);
    }
    ...
    public async Task Handle_ShouldNotifyViaSignalR()
    {
        ...
        await _hubNotifier.Received(1).NotifyAppointmentCancelledAsync(
            tenantId,
