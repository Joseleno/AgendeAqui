...
public class GetAttendanceReportQueryValidatorTests
{
    ...
    public void Validate_WithSameDates_ShouldHaveNoErrors()
    {
        ...
        var query = new GetAttendanceReportQuery(date, date);
    ...
    {
        var query = new GetAttendanceReportQuery(default, new DateOnly(2026, 1, 31));
    ...
    {
        var query = new GetAttendanceReportQuery(new DateOnly(2026, 1, 1), default);
